...
public class LiveLineActivity extends AppCompatActivity {
    private static String TAGC = LiveLineActivity.class.getName();
...
//            }
        ...
        protected void onPreExecute() {
            acProgressFlower = new ACProgressFlower.Builder(LiveLineActivity.this)
    ...
    protected void onResume() {
        super.onResume();
        if (CommonMethod.isNetworkAvailable(LiveLineActivity.this)) {
            new AsyncTaskDetailMatch().execute(this.match_key);
        } else {
            CommonMethod.showAlert("Internet Connectivity Failure", LiveLineActivity.this);
        }
    }
